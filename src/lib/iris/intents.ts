...
const intentPatterns: Record<AllowedIntent, string[]> = {
  ...
  experience_highlight: [
    'highlight', 'impact', 'most impactful', 'most impactful role', 'most impactful work'
  ],
  experience_role: [
  ...
  projects_highlight: [
    'best project', 'favorite project', 'most proud', 'most impressive',
    'highlight', 'standout', 'top project', 'most challenging'
  ],
  project_specific: [
  ...
  analytics_overview: [
    'analytics', 'overview', 'statistics', 'metrics', 'data', 'visuals'
  ],
  navigate_projects: [
    'projects', 'work', 'portfolio', 'built', 'created', 'developed',
    'what have you built', 'showcase', 'examples'
  ...
  navigate_blog: [
    'blog', 'writing', 'articles', 'posts', 'content'
  ],
  navigate_contact: [
    'contact', 'email', 'reach out', 'get in touch', 'linkedin', 'connect',
    'how to contact', 'reach you', 'message', 'communication'
  ...
  navigate_home: [
    'home', 'back to home', 'go home', 'main page'
  ]
};
