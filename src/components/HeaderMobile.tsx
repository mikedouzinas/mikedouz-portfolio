          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <button
                ...
                className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-gray-200/60 dark:bg-gray-800/60 hover:bg-gray-300/80 dark:hover:bg-gray-700/80 transition-colors focus:outline-none focus:ring-2 focus:ring-orange-500 dark:focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900"
              >
