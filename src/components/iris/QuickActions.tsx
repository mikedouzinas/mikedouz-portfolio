      ...
      <div className="mb-3">
        <div className="flex gap-2">
          <button
            type="button"
            disabled
            className={`flex-shrink-0 flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs sm:text-sm font-medium whitespace-nowrap bg-gradient-to-r ${getActionColor(selectedAction)} text-white opacity-70`}
          >
      ...
      {showCustomInput ? (
        <div className="flex gap-2">
          ...
          <button
            ...
            className="flex-shrink-0 flex items-center gap-1.5 px-3 py-2 rounded-xl text-sm font-medium transition-all bg-gradient-to-r from-sky-500 to-indigo-600 text-white hover:scale-105 disabled:opacity-50 disabled:scale-100"
          >
        ...
        <div className="flex gap-2 overflow-x-auto py-2 -mx-1 px-1 scrollbar-none">
          ...
          {actions.map((action, index) => (
            <button
              ...
              disabled={disabled}
              className={`flex-shrink-0 flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs sm:text-sm font-medium transition-all duration-200 transform whitespace-nowrap bg-gradient-to-r ${getActionColor(action)} text-white hover:scale-105 disabled:opacity-50 disabled:scale-100`}
            >
